    ...
    public Screen GenerateScreen(Screen parentScreen) {
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .description(OptionDescription.of(Text.literal("When enabled, fireworks will also be swapped into your offhand when your elytra is switched, assuming you have any.")))
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .tooltip(Text.literal("Configure which items are used during a swap"))
                        .group(ListOption.<Item>createBuilder()
                                .name(Text.literal("Elytra swap items"))
                                .description(OptionDescription.of(Text.literal("Loops through this list during the elytra swap check.")))
                                ...
                                .build())
                        .group(ListOption.<Item>createBuilder()
                                .name(Text.literal("Offhand swap group #1"))
                                .description(OptionDescription.of(Text.literal("Loops through this list during the offhand swap check.")))
                                ...
                                .build())
                        .group(ListOption.<Item>createBuilder()
                                .name(Text.literal("Offhand swap group #2"))
                                .description(OptionDescription.of(Text.literal("Loops through this list during the offhand swap check.")))
                        ...
                        .group(ListOption.<Item>createBuilder()
                                ...
                                .description(OptionDescription.of(Text.literal("Loops through this list during the automatic firework swap.")))
